...
#define T_GREEN_NS      3000
#define T_YELLOW_NS     2000
#define T_GREEN_EW      3000
#define T_YELLOW_EW     2000
#define ALL_RED_MS         0
...
/*Use 1 to turn that LED ON, 0 to turn it OFF*/
